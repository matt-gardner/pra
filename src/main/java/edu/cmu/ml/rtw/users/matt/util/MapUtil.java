...
public class MapUtil {
    ...
    public static <K1, K2, V> void addValueToTwoKeyList(Map<K1, Map<K2, List<V>>> map,
                                                        ...
                                                        K2 key2,
                                                        V value) {
        Map<K2, List<V>> key1Map = MapUtil.getWithDefaultAndAdd(map,
                                                                key1,
                                                                new HashMap<K2, List<V>>());
     ...
     */
    public static <K, V> void addValueToKeyList(Map<K, List<V>> map,
                                                K key,
                                                V value) {
     ...
     */
    public static <K, V> void addValueToKeySet(Map<K, Set<V>> map,
                                               K key,
                                               V value) {
