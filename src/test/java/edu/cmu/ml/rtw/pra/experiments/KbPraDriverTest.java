...
public class KbPraDriverTest extends TestCase {
  ...
  public void testCreateUnallowedEdges() throws IOException {
      ...
      List<Integer> unallowedEdges = KbPraDriver.createUnallowedEdges(relation,
                                                                      inverses,
                                                                      embeddings,
                                                                      edgeDict);
      ...
      unallowedEdges = KbPraDriver.createUnallowedEdges(relation,
      ...
      unallowedEdges = KbPraDriver.createUnallowedEdges(relation2,
                                                        inverses,
                                                        null,
                                                        edgeDict);
  ...
  public void testInitializeSplit() throws IOException {
      ...
      assertEquals(false, KbPraDriver.initializeSplit(splitsDirectory,
                                                      kbDirectory,
                                                      relation,
                                                      builder,
                                                      factory,
      ...
      assertEquals(true, KbPraDriver.initializeSplit(splitsDirectory,
                                                     kbDirectory,
